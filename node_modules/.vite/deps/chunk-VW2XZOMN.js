...
function useCacheToken(theme, tokens) {
  ...
  var mergedToken = React8.useMemo(function() {
    return Object.assign.apply(Object, [{}].concat(_toConsumableArray(tokens)));
  }, [tokens]);
  var tokenStr = React8.useMemo(function() {
    return flattenToken(mergedToken);
  }, [mergedToken]);
  var overrideTokenStr = React8.useMemo(function() {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React27.forwardRef(function(props, ref) {
    ...
    var setNodeRef = React27.useCallback(function(node) {
...
var RowContext = (0, import_react15.createContext)({});
...
var Col = React32.forwardRef((props, ref) => {
  const {
    getPrefixCls,
    direction
  ...
  const {
    gutter,
    wrap
  } = React32.useContext(RowContext_default);
  const {
  ...
  return wrapSSR(React32.createElement("div", Object.assign({}, others, {
...
function useForceUpdate() {
  const [, forceUpdate] = React33.useReducer((x) => x + 1, 0);
  return forceUpdate;
}
...
function useBreakpoint() {
  ...
  const screensRef = (0, import_react17.useRef)({});
...
function useMergePropByScreen(oriProp, screen) {
  const [prop, setProp] = React35.useState(typeof oriProp === "string" ? oriProp : "");
...
var Row = React35.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    justify,
    align,
  ...
  const [screens, setScreens] = React35.useState({
    xs: true,
    sm: true,
    md: true,
    lg: true,
  ...
  const [curScreens, setCurScreens] = React35.useState({
    xs: false,
    sm: false,
    md: false,
    lg: false,
  ...
  const gutterRef = React35.useRef(gutter);
  const responsiveObserver = useResponsiveObserver();
  React35.useEffect(() => {
  ...
  const rowContext = React35.useMemo(() => ({
    gutter: [gutterH, gutterV],
    wrap
  }), [gutterH, gutterV, wrap]);
  return wrapSSR(React35.createElement(RowContext_default.Provider, {
    value: rowContext
  }, React35.createElement("div", Object.assign({}, others, {
    className: classes,
...
var ListContext = import_react18.default.createContext({});
...
var Meta = (_a) => {
  ...
  const content = import_react19.default.createElement("div", {
    className: `${prefixCls}-item-meta-content`
  }, title && import_react19.default.createElement("h4", {
    className: `${prefixCls}-item-meta-title`
  }, title), description && import_react19.default.createElement("div", {
    className: `${prefixCls}-item-meta-description`
  }, description));
  return import_react19.default.createElement("div", Object.assign({}, others, {
    className: classString
  }), avatar && import_react19.default.createElement("div", {
    className: `${prefixCls}-item-meta-avatar`
  }, avatar), (title || description) && content);
};
var InternalItem = (_a, ref) => {
  var {
    prefixCls: customizePrefixCls,
    children,
    actions,
    ...
    className,
    colStyle
  } = _a, others = __rest6(_a, ["prefixCls", "children", "actions", "extra", "className", "colStyle"]);
  const {
    grid,
    itemLayout
  } = (0, import_react19.useContext)(ListContext);
  const {
    getPrefixCls
  } = (0, import_react19.useContext)(ConfigContext);
  const isItemContainsTextNodeAndNotSingular = () => {
    let result;
    import_react19.Children.forEach(children, (element) => {
      if (typeof element === "string") {
        result = true;
      }
    });
    return result && import_react19.Children.count(children) > 1;
  };
  const isFlexMode = () => {
  ...
  const prefixCls = getPrefixCls("list", customizePrefixCls);
  const actionsContent = actions && actions.length > 0 && import_react19.default.createElement("ul", {
    className: `${prefixCls}-item-action`,
    key: "actions"
  }, actions.map((action, i) => (
    // eslint-disable-next-line react/no-array-index-key
    import_react19.default.createElement("li", {
      key: `${prefixCls}-item-action-${i}`
    }, action, i !== actions.length - 1 && import_react19.default.createElement("em", {
      className: `${prefixCls}-item-action-split`
    }))
  )));
  const Element = grid ? "div" : "li";
  const itemChildren = import_react19.default.createElement(Element, Object.assign({}, others, !grid ? {
    ref
  } : {}, {
    className: (0, import_classnames4.default)(`${prefixCls}-item`, {
      [`${prefixCls}-item-no-flex`]: !isFlexMode()
    }, className)
  }), itemLayout === "vertical" && extra ? [import_react19.default.createElement("div", {
    className: `${prefixCls}-item-main`,
    key: "content"
  }, children, actionsContent), import_react19.default.createElement("div", {
    className: `${prefixCls}-item-extra`,
    key: "extra"
  }, extra)] : [children, actionsContent, cloneElement2(extra, {
    key: "extra"
  })]);
  return grid ? import_react19.default.createElement(col_default, {
    ref,
    flex: 1,
    style: colStyle
  }, itemChildren) : itemChildren;
};
var Item = (0, import_react19.forwardRef)(InternalItem);
Item.Meta = Meta;
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VW2XZOMN.js.map
